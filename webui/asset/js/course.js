...
function getRate(rate) {
  ...
  return $('<span>')
    .append($('<img>').attr('src', getRateAsset(rateArray[0])).attr('style', 'height: 30px;'))
    .append($('<img>').attr('src', getRateAsset(rateArray[1])).attr('style', 'height: 30px;'))
    .append($('<img>').attr('src', getRateAsset(rateArray[2])).attr('style', 'height: 30px;'))
    .append(
      $('<img>').attr('src', 'static/asset/skill_tex_percent.png').attr('style', 'height: 20px;')
    )
              ...
              $('<div class="course-content">')
                .append(
                  $('<table class="is-center">')
                    .append(
                      $('<tr>').append($('<td>').append(info.skillName + (stype ? ' (God)' : '')))
                    )
                    .append(
                      $('<tr>').append(
                        $('<td>')
                          ...
                          .append($('<img>').attr('src', getMedalAsset(clear_medal)))
...
$(document).ready(function () {
  ...
  currentVersion =
    course_data.length > 0 ? course_data.sort((a, b) => b.version - a.version)[0].version : 0;
