      ...
      versionCourseData.forEach(function (item, index) {
        item.courses.forEach(function (item2, index2) {
          if (
            ...
            console.log(
              item['name'] + ' included in ' + selectedCourseLevel + ' in ' + selectedVersion
            );
          ...
          $('.track-difficulty')
            ...
            .append(
              '<option value=' +
                ...
                '>' +
                (track.difficulty['infinite'] != '0'
                  ? infLabel[parseInt(track.info.inf_ver)]
                  : difficultyLabels[4]) +
                ' (' +
                (track.difficulty['infinite'] != '0'
                  ? track.difficulty['infinite']
                  : track.difficulty['maximum']) +
                ')</option>'
            );
        }
    ...
    if (track) {
      ...
      if (track.difficulty['maximum'] != '0' || track.difficulty['infinite'] != '0') {
        $('.track-difficulty')
          ...
          .append(
            '<option value=' +
              (parseInt(track.info.inf_ver) != 0 ? 3 : 4) +
              '>' +
              (track.difficulty['infinite'] != '0'
                ? infLabel[parseInt(track.info.inf_ver)]
                : difficultyLabels[4]) +
