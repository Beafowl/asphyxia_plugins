...
import { getVersion, IDToCode, checkVerStart, loadMusicDb, isValidMid, isCustomMid, computeForce } from '../utils'
...
import { DB_VER, iiMigrate, viiMigrate, nablaMigrate } from './migrate'
  ...
  if (version === -6 || version === 7) { // Using alternate scoring system after 20210831
    ...
    try {
      for (const i of tracks) {
        ...
        // the in-game / web-UI volforce ranking.
        if (isCustomMid(mid)) {
          record.volforce = 0;
